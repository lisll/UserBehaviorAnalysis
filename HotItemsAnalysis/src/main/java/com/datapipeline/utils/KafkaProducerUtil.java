...
public class KafkaProducerUtil {
    ...
    public static void writeToKafka(String topic) throws Exception{
        ...
        // 用缓冲方式读取文本
        BufferedReader bufferedReader = new BufferedReader(new FileReader("/Users/sll/develop/workspace_idea/flink/UserBehaviorAnalysis/HotItemsAnalysis/src/main/resources/UserBehavior.csv"));
        String line;
